...
export default function UploadEtapa2_1Page() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (unassociatedFiles.length > 0) {
        router.push('/gerenciador/upload_completo/2/2' as any);
      } else {
  ...
  return (
    <div className="container mx-auto p-4 max-w-5xl">
      ...
      <div className="flex items-center justify-center gap-2 mb-8">
        ...
        <Button variant="default" className="w-24">Etapa 2.1</Button>
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold">Selecionar Primeira Ferramenta - Etapa 2.1</h1>
        <p className="text-gray-600 mt-2">
          Selecione ou adicione a primeira ferramenta para seus documentos.
        </p>
      </div>
      ...
      <Card className="p-6">
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-lg font-semibold mb-4">Primeira Ferramenta</h2>
            <ToolSelector
              tools={tools}
            ...
            <div className="mt-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-4">
                  Selecione os arquivos que deseja associar à primeira ferramenta. 
